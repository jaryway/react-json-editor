...
module.exports = function(modules) {
  ...
  const plugins = [
    ...
    [resolve('babel-plugin-import'), { libraryName: 'antd', libraryDirectory, style: true }, 'ant'],
    [resolve('babel-plugin-import'), { libraryName: 'fregata', libraryDirectory, style: true }, 'fregata'],
    [resolve('babel-plugin-module-resolver'), { '@': './src' }],
  ];
  return {
    presets: [
